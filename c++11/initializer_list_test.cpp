...
int main (int argc, char* argv[]) 
{
    ...
    // int i1= 3.14;    // compiles despite narrowing, runs at our risk, warning from Clang
    int i2= {3};
    // long l= {1234567890123};
    long l2= 1234567890123;
    // int il2= 0x1234567890; // compiles despite narrowing, runs at our risk, warning from Clang
    // std::cout << "il2 is " << std::hex << il2 << '\n';
